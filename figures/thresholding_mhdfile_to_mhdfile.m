...
adc = dir([subject.folder '\' subject.name '\mhd\*ADC*150*.mhd']);
...
metaImageWrite(adc_thresh,[subject.folder '\' subject.name '\mhd\' 'meanADCthresh175onCSF.mhd']);
...
metaImageWrite(adc_thresh,[subject.folder '\' subject.name '\mhd\' 'meanADCthresh150onCSF.mhd']);
