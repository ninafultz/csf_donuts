...
roi_patterns = {'masked_b0_ADC_mhd_thr75.0000_ACA_v2'} %
% % %20201019_Reconstruction ACA

% roi_patterns = {'masked_b0_ADC_mhd_thr100.0000_MCA_roundseg'} %
%20191112_Reconstruction MCA

% roi_patterns = {'masked_b0_ADC_mhd_thr150.0000_ICA'} % 20201019_Reconstruction ICA

%adc_map
adc_map = 'masked_b0_ADC_mhd_thr75.0000.nii'
%m2 donuts
% roi_patterns = {'20201014_312_316_166_M2_roundseg'} % % use adc_map thr100
% roi_patterns = {'20201014_133_340_142_M2_roundseg'} %
%20201014_Reconstruction MCA

% roi_patterns = {'ACEPOINT'} %
%20191022 - peripheral donut example
%% 
...
categories = {'eye donut', 'full donut', 'compartment', 'no donut'};
