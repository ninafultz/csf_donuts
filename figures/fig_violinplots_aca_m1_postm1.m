...
title('Mean CSF Mobility across Arteries');
ylabel('Mean ADC (mm^2/s)'); hold on
ylim([0 0.06]);
...
% data1 vs data2: p = 0.00149, significant? 1
% data1 vs data3: p = 0.19180, significant? 0
% data2 vs data3: p = 0.00124, significant? 1
