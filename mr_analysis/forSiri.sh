...
parallel ./biasfieldcorrection --with-segmentation --overwrite /exports/gorter-hpc/users/ninafultz/SiriRegistration/{}/T1w.nii /exports/gorter-hpc/users/ninafultz/SiriRegistration/{}/T1w_bc.nii ::: sub-01 sub-02 sub-03 sub-04 sub-05 sub-06 sub-07 sub-08 sub-09 sub-10 sub-11 sub-12 sub-13 sub-14 sub-15 sub-16 sub-17 sub-18 sub-19
