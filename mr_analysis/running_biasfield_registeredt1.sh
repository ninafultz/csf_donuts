...
*************************************************************************************** "
    echo Usage: ./biasfieldcorrection.sh -n
       -n: Name of subject
}
...
./biasfieldcorrection --with-segmentation --overwrite $SUBJECT_NAME/reoriented/3dT1_0.9mm_to_B0_properOrientation.nii $SUBJECT_NAME/reoriented/3dT1_0.9mm_to_B0_properOrientation_bc.nii
