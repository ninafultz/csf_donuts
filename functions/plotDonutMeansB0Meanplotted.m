function plotDonutMeansB0Meanplotted(project_directory, project_name, subject_list, roi_patterns, voxel_size);
roi_data = struct();
...
legend('Location', 'best');
    ...
    % Plot the mean ADC values with a solid line
    yyaxis left
    plot(unique_x_mm, mean_adc, '-o', 'LineWidth', 1, 'DisplayName', 'Mean ADC', 'Color', 'r');
